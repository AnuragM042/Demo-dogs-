...
const Tripinida1 = () => {
    return (
        <div className="flex flex-col items-center justify-center bg-[#D6D3D1]">
          ...
          <div className='flex flex-col justify-center items-center mt-10 px-4 lg:px-[500px] md:px-[200px] space-y-4'>
            ...
            <div className='flex flex-col items-center text-center'>
              <p className='font-["Cambria"] font-medium text-xl'>Making India Pet Friendly  </p>
              <h3 className='font-["Cambria"] font-bold  text-xl '>Explore Incredible India</h3> 
              <p className='font-["Lato"] font-medium text-l'>
        ...
        <p className='font-["Lato"] font-semibold '>
         ...
         <Button className="font-['Cambria'] bg-black p-[15px] border border-white flex items-center " ripple={true}>
