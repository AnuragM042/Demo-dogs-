...
const Ourpartner = () => {
  return (
    <div className='bg-[#D6D3D1]'>
        ...
        {/* Partners  */}
        <div className='flex items-center justify-center gap-2 space-y-6 bg-black '>
            <img className="rounded-lg hover:animate-tilt-n-move-shaking"  src={Image1} alt="" />
            <img className="rounded-lg hover:animate-tilt-n-move-shaking w-[250px]" src={Image2} alt="" />
        </div>
